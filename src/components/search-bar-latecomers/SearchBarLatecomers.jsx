...
const SearchBarLatecomers = () => {
  ...
  const filterById = `http://192.168.42.176:2010/api/v1/agents/findByFilter?name=null&operator_number=${
    inputValue?.trim() || null
  }&status=null`;
  const filterByName = `http://192.168.42.176:2010/api/v1/agents/findByFilter?name=${
    inputValue?.trim() || null
